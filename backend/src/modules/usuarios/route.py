...
@router.get("/all", response_model=list[UsuarioResponse], dependencies=[Depends(obtener_usuario_admin)])
async def listar():
    return await controller.listar()

@router.get("/inactivos", response_model=list[UsuarioResponse], dependencies=[Depends(obtener_usuario_admin)])
async def listar_inactivos():
    return await controller.listar_inactivos()

@router.get("/activos", response_model=list[UsuarioResponse], dependencies=[Depends(obtener_usuario_admin)])
async def listar_activos():
    return await controller.listar_activos()

@router.get("/buscar", response_model=list[UsuarioResponse], dependencies=[Depends(obtener_usuario_admin)])
...
@router.get("/identificador/{identificador}",response_model=UsuarioResponse,dependencies=[Depends(obtener_usuario_admin)])
async def obtener_por_identificador(identificador: UUID):
    return await controller.obtener_por_identificador(identificador)

@router.get("/{id}", response_model=UsuarioResponse, dependencies=[Depends(obtener_usuario_admin)])
async def obtener_id(id: PydanticObjectId):
    return await controller.obtener_id(id)

@router.patch("/{id}/activar",response_model=RespuestaConMensaje[UsuarioResponse],dependencies=[Depends(obtener_usuario_admin)])
...
@router.patch("/{id}/desactivar",response_model=RespuestaConMensaje[UsuarioResponse],dependencies=[Depends(obtener_usuario_admin)])
