...
import { useCrearCategoriaProducto } from "../hooks/categorias/useCrearCategoria";
...
export function CategoriaProductoPage() {
  const { categorias, loading: cargandoLista, error: errorLista, recargar } = useCategoriaProducto();
  const { crear, loading: creando, errores, errorApi } = useCrearCategoriaProducto();
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <h1 className="text-2xl font-bold mb-6">Categorias Productos</h1>
